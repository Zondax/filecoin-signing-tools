...
mod tests {
    use crate::api::UnsignedMessageUserAPI;
    use crate::{sign_transaction, verify_signature, key_generate_mnemonic, key_derive};
    use hex::decode;
    ...
    const EXAMPLE_PRIVATE_KEY: &str = "f15716d3b003b304b8055d9cc62e6b9c869d56cc930c3858d4d7c31f5f53f14a";
    ...
    fn verify_invalid_signature() {
        // Path 44'/461'/0/0/0
        let prvkey =
            decode(EXAMPLE_PRIVATE_KEY).unwrap();
    ...
    fn derive_child_key() {
        ...
        let (prvkey, publickey, address) = key_derive(mnemonic.to_string(), path.to_string()).expect("FIX ME");
